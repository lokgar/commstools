...
demultiplex_polarization_tones_dynamic :
    Time-varying polarization demux that tracks a rotating SOP by per-tone
    mix-down + low-pass (continuous Jones-matrix estimate; for long captures
    where the static one-shot inverse fails).
"""
